...
t_transfer t_text_model::f_slice(size_t a_p, size_t a_n) const
{
...
void t_text_model::f_replace(size_t a_p, size_t a_n, const t_transfer& a_segments, const std::wstring& a_text)
{
	{
		size_t n = f_text_size();
...
t_xrafttv::t_xrafttv(::xemmai::t_object* a_module, const t_transfer& a_xraft) : ::xemmai::t_extension(a_module), v_module_xraft(a_xraft)
{
...
t_transfer t_type_of<t_attribute>::f_construct(::xemmai::t_object* a_class, t_slot* a_stack, size_t a_n)
{
	return t_construct_with<t_transfer (*)(::xemmai::t_object*, t_pixel, t_pixel), f_construct>::t_bind<t_attribute>::f_do(a_class, a_stack, a_n);
}

void t_type_of<t_text_model>::f_define(t_extension* a_extension)
{
	t_define<t_text_model, xraft::t_object>(a_extension, L"TextModel")
		(L"add_loaded", t_member<void (t_text_model::*)(const t_transfer&), &t_text_model::f_add_loaded, t_with_application_thread>())
		(L"remove_loaded", t_member<void (t_text_model::*)(const t_transfer&), &t_text_model::f_remove_loaded, t_with_application_thread>())
		(L"add_replacing", t_member<void (t_text_model::*)(const t_transfer&), &t_text_model::f_add_replacing, t_with_application_thread>())
		(L"remove_replacing", t_member<void (t_text_model::*)(const t_transfer&), &t_text_model::f_remove_replacing, t_with_application_thread>())
		(L"add_replaced", t_member<void (t_text_model::*)(const t_transfer&), &t_text_model::f_add_replaced, t_with_application_thread>())
		(L"remove_replaced", t_member<void (t_text_model::*)(const t_transfer&), &t_text_model::f_remove_replaced, t_with_application_thread>())
		...
		(L"slice", t_member<t_transfer (t_text_model::*)(size_t, size_t) const, &t_text_model::f_slice, t_with_application_thread>())
		(L"replace", t_member<void (t_text_model::*)(size_t, size_t, const t_transfer&, const std::wstring&), &t_text_model::f_replace, t_with_application_thread>())
...
t_transfer t_type_of<t_text_model>::f_construct(::xemmai::t_object* a_class, t_slot* a_stack, size_t a_n)
{
	return t_construct_with<t_transfer (*)(::xemmai::t_object*), f_construct>::t_bind<t_text_model>::f_do(a_class, a_stack, a_n);
}
...
void t_type_of<t_wrapped_view>::f_define(t_extension* a_extension)
{
	t_define<t_wrapped_view, xraft::t_object>(a_extension, L"WrappedView")
		(L"add_invalidated", t_member<void (t_wrapped_view::*)(const t_transfer&), &t_wrapped_view::f_add_invalidated, t_with_application_thread>())
		(L"remove_invalidated", t_member<void (t_wrapped_view::*)(const t_transfer&), &t_wrapped_view::f_remove_invalidated, t_with_application_thread>())
		(L"add_resized", t_member<void (t_wrapped_view::*)(const t_transfer&), &t_wrapped_view::f_add_resized, t_with_application_thread>())
		(L"remove_resized", t_member<void (t_wrapped_view::*)(const t_transfer&), &t_wrapped_view::f_remove_resized, t_with_application_thread>())
		(L"add_moved", t_member<void (t_wrapped_view::*)(const t_transfer&), &t_wrapped_view::f_add_moved, t_with_application_thread>())
		(L"remove_moved", t_member<void (t_wrapped_view::*)(const t_transfer&), &t_wrapped_view::f_remove_moved, t_with_application_thread>())
...
t_transfer t_type_of<t_wrapped_view>::f_construct(::xemmai::t_object* a_class, t_slot* a_stack, size_t a_n)
{
	return t_construct_with<t_transfer (*)(::xemmai::t_object*), f_construct>::t_bind<t_wrapped_view>::f_do(a_class, a_stack, a_n);
}
