...
void t_type_of<xemmaix::xrafttv::t_attribute>::f_define(t_extension* a_extension)
{
	...
	t_define<t_attribute, xraft::t_object>(a_extension, L"Attribute")
...
void t_type_of<xemmaix::xrafttv::t_text_model>::f_define(t_extension* a_extension)
{
	...
	t_define<t_text_model, xraft::t_object>(a_extension, L"TextModel")
		...
		(L"segment_to_attribute", t_member<const t_pointer<t_attribute>&(t_text_model::*)(size_t) const, &t_text_model::f_segment_to_attribute, t_with_application_thread>())
...
void t_type_of<xemmaix::xrafttv::t_wrapped_view>::f_define(t_extension* a_extension)
{
	...
	t_define<t_wrapped_view, xraft::t_object>(a_extension, L"WrappedView")
		...
		(L"font", t_member<const t_pointer<t_font>&(t_wrapped_view::*)() const, &t_wrapped_view::f_font, t_with_application_thread>())
		(L"font__", t_member<void(t_wrapped_view::*)(const t_pointer<t_font>&), &t_wrapped_view::f_font__, t_with_application_thread>())
		(L"model", t_member<const t_pointer<t_text_model>&(t_wrapped_view::*)() const, &t_wrapped_view::f_model, t_with_application_thread>())
		(L"model__", t_member<void(t_wrapped_view::*)(const t_pointer<t_text_model>&), &t_wrapped_view::f_model__, t_with_application_thread>())
...
{
	return new xemmaix::xrafttv::t_extension(a_module, xemmai::t_module::f_instantiate(L"xraft"));
}
