...
void t_type_of<t_point>::f_define(t_extension* a_extension)
{
...
t_type* t_type_of<t_point>::f_derive(t_object* a_this)
{
	return new t_type_of(v_module, a_this);
}

void t_type_of<t_point>::f_finalize(t_object* a_this)
{
	delete f_as<t_point*>(a_this);
}

t_transfer t_type_of<t_point>::f_construct(::xemmai::t_object* a_class, t_slot* a_stack, size_t a_n)
{
	return t_construct<int, int>::t_bind<t_point>::f_do(a_class, a_stack, a_n);
}

void t_type_of<t_extent>::f_define(t_extension* a_extension)
{
...
t_type* t_type_of<t_extent>::f_derive(t_object* a_this)
{
	return new t_type_of(v_module, a_this);
}

void t_type_of<t_extent>::f_finalize(t_object* a_this)
{
	delete f_as<t_extent*>(a_this);
}

t_transfer t_type_of<t_extent>::f_construct(::xemmai::t_object* a_class, t_slot* a_stack, size_t a_n)
{
	return t_construct<unsigned, unsigned>::t_bind<t_extent>::f_do(a_class, a_stack, a_n);
}

void t_type_of<t_rectangle>::f_define(t_extension* a_extension)
{
...
t_type* t_type_of<t_rectangle>::f_derive(t_object* a_this)
{
	return new t_type_of(v_module, a_this);
}

void t_type_of<t_rectangle>::f_finalize(t_object* a_this)
{
	delete f_as<t_rectangle*>(a_this);
}

t_transfer t_type_of<t_rectangle>::f_construct(::xemmai::t_object* a_class, t_slot* a_stack, size_t a_n)
{
	return
		t_overload<t_construct<const t_point&, const t_extent&>,
		t_overload<t_construct<int, int, unsigned, unsigned>
	> >::t_bind<t_rectangle>::f_do(a_class, a_stack, a_n);
}
