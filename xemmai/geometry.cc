...
t_scoped t_type_of<t_point>::f_construct(::xemmai::t_object* a_class, t_stacked* a_stack, size_t a_n)
{
...
t_scoped t_type_of<t_extent>::f_construct(::xemmai::t_object* a_class, t_stacked* a_stack, size_t a_n)
{
...
t_scoped t_type_of<t_rectangle>::f_construct(::xemmai::t_object* a_class, t_stacked* a_stack, size_t a_n)
{
	return t_overload<
		t_construct<const t_point&, const t_extent&>,
