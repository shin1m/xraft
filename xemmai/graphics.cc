...
t_object* t_type_of<xraft::t_graphics::t_function>::f_define(t_library* a_library)
{
	...
	{
		a_fields
		(L"CLEAR"sv, t_graphics::c_function__CLEAR)
		(L"AND"sv, t_graphics::c_function__AND)
		(L"AND_REVERSE"sv, t_graphics::c_function__AND_REVERSE)
		(L"COPY"sv, t_graphics::c_function__COPY)
		(L"AND_INVERTED"sv, t_graphics::c_function__AND_INVERTED)
		(L"NOOP"sv, t_graphics::c_function__NOOP)
		(L"XOR"sv, t_graphics::c_function__XOR)
		(L"OR"sv, t_graphics::c_function__OR)
		(L"NOR"sv, t_graphics::c_function__NOR)
		(L"EQUIV"sv, t_graphics::c_function__EQUIV)
		(L"INVERT"sv, t_graphics::c_function__INVERT)
		(L"OR_REVERSE"sv, t_graphics::c_function__OR_REVERSE)
		(L"COPY_INVERTED"sv, t_graphics::c_function__COPY_INVERTED)
		(L"OR_INVERTED"sv, t_graphics::c_function__OR_INVERTED)
		(L"NAND"sv, t_graphics::c_function__NAND)
		(L"SET"sv, t_graphics::c_function__SET)
		;
	});
}
