...
t_scoped t_type_of<t_font>::f_construct(::xemmai::t_object* a_class, t_stacked* a_stack, size_t a_n)
{
...
t_scoped t_type_of<t_color>::f_construct(::xemmai::t_object* a_class, t_stacked* a_stack, size_t a_n)
{
#ifdef XRAFT_X11
	return t_overload<
