...
t_scoped t_type_of<t_widget>::f_construct(::xemmai::t_object* a_class, t_scoped* a_stack, size_t a_n)
{
...
t_scoped t_type_of<t_shell>::f_construct(::xemmai::t_object* a_class, t_scoped* a_stack, size_t a_n)
{
...
t_scoped t_type_of<t_frame>::f_construct(::xemmai::t_object* a_class, t_scoped* a_stack, size_t a_n)
{
