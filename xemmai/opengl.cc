...
t_scoped t_type_of<t_opengl_format>::f_construct(::xemmai::t_object* a_class, t_stacked* a_stack, size_t a_n)
{
	return t_overload<
...
t_scoped t_type_of<t_opengl_widget>::f_construct(::xemmai::t_object* a_class, t_stacked* a_stack, size_t a_n)
{
...
t_scoped t_type_of<t_opengl_context>::f_construct(::xemmai::t_object* a_class, t_stacked* a_stack, size_t a_n)
{
	return t_overload<
		t_construct_with<t_scoped (*)(::xemmai::t_object*, const xraft::t_pointer<t_opengl_format>&), f_construct>,
		t_construct_with<t_scoped (*)(::xemmai::t_object*, const xraft::t_pointer<t_opengl_format>&, const xraft::t_pointer<t_opengl_context>&), f_construct>
