...
void t_type_of<t_application>::f_define(t_extension* a_extension)
{
	t_define<t_application, ::xemmai::t_object>(a_extension, L"Application")
		...
		(L"pointer_grabber", t_member<xraft::t_pointer<t_window> (t_application::*)() const, &t_application::f_pointer_grabber, t_with_application_thread>())
		(L"pointer_grabber__", t_member<void (t_application::*)(const xraft::t_pointer<t_window>&), &t_application::f_pointer_grabber__, t_with_application_thread>())
		(L"pointer", t_member<t_point (t_application::*)() const, &t_application::f_pointer, t_with_application_thread>())
		(L"input_context", t_member<const xraft::t_pointer<t_input_context>& (t_application::*)() const, &t_application::f_input_context, t_with_application_thread>())
#ifdef XRAFT_X11
...
#endif
		(L"font", t_member<const xraft::t_pointer<t_font>& (t_application::*)() const, &t_application::f_font, t_with_application_thread>())
		(L"count", t_member<size_t (t_application::*)() const, &t_application::f_count, t_with_application_thread>())
		(L"at", t_member<const xraft::t_pointer<t_shell>& (t_application::*)(size_t) const, &t_application::f_at, t_with_application_thread>())
		(L"add",
