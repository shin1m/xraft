...
t_transfer t_type_of<xraft::t_object>::f_construct(::xemmai::t_object* a_class, t_slot* a_stack, size_t a_n)
{
	t_throwable::f_throw(L"uninstantiatable.");
	return t_transfer();
}

void t_type_of<xraft::t_object>::f_instantiate(::xemmai::t_object* a_class, t_slot* a_stack, size_t a_n)
{
