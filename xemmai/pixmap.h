...
{
	static t_transfer f_construct(::xemmai::t_object* a_class, unsigned a_width, unsigned a_height)
	{
		return xraft::xemmai::t_proxy::f_construct(a_class, new t_bitmap(a_width, a_height));
	}
	static t_transfer f_construct(::xemmai::t_object* a_class, unsigned a_width, unsigned a_height, const t_bytes& a_data)
	{
		return f_construct(a_class, a_width, a_height, a_data, 0);
	}
	static t_transfer f_construct(::xemmai::t_object* a_class, unsigned a_width, unsigned a_height, const t_bytes& a_data, int a_bytes_per_line)
	{
...
struct t_type_of<t_pixmap> : t_type_of<t_drawable>
{
	...
	static t_transfer f_construct(::xemmai::t_object* a_class, unsigned a_width, unsigned a_height, bool a_alpha)
	{
		return xraft::xemmai::t_proxy::f_construct(a_class, new t_pixmap(a_width, a_height, a_alpha));
	}
	static t_transfer f_construct(::xemmai::t_object* a_class, unsigned a_width, unsigned a_height, bool a_alpha, const t_bytes& a_data)
	{
	...
	static t_transfer f_construct(::xemmai::t_object* a_class, unsigned a_width, unsigned a_height, bool a_alpha, const t_bytes& a_data, int a_bytes_per_line)
	{
