...
struct t_type_of<xraft::t_bitmap> : t_bears<xraft::t_bitmap, t_type_of<xraft::t_drawable>>
{
	...
	static t_scoped f_construct(t_type* a_class, unsigned a_width, unsigned a_height, const t_bytes& a_data)
	{
		return f_construct(a_class, a_width, a_height, a_data, 0);
	}
	static t_scoped f_construct(t_type* a_class, unsigned a_width, unsigned a_height, const t_bytes& a_data, int a_bytes_per_line)
	{
...
struct t_type_of<xraft::t_pixmap> : t_bears<xraft::t_pixmap, t_type_of<xraft::t_drawable>>
{
	...
	static t_scoped f_construct(t_type* a_class, unsigned a_width, unsigned a_height, bool a_alpha)
	{
		return xemmaix::xraft::t_proxy::f_construct(a_class, new xraft::t_pixmap(a_width, a_height, a_alpha));
	}
	static t_scoped f_construct(t_type* a_class, unsigned a_width, unsigned a_height, bool a_alpha, const t_bytes& a_data)
	{
	...
	static t_scoped f_construct(t_type* a_class, unsigned a_width, unsigned a_height, bool a_alpha, const t_bytes& a_data, int a_bytes_per_line)
	{
