...
{
	static t_scoped f_construct(::xemmai::t_object* a_class, const xraft::t_pointer<t_opengl_format>& a_format)
	{
		return xraft::xemmai::t_proxy::f_construct(a_class, new t_opengl_context(a_format));
	}
	static t_scoped f_construct(::xemmai::t_object* a_class, const xraft::t_pointer<t_opengl_format>& a_format, const xraft::t_pointer<t_opengl_context>& a_share)
	{
