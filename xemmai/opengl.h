...
{
	static t_scoped f_construct(t_type* a_class, bool a_rgba)
	{
		return xemmaix::xraft::t_proxy::f_construct(a_class, new xraft::t_opengl_format(a_rgba));
	}
	static t_scoped f_construct(t_type* a_class, bool a_rgba, bool a_double_buffer)
	{
		return xemmaix::xraft::t_proxy::f_construct(a_class, new xraft::t_opengl_format(a_rgba, a_double_buffer));
	}
	static t_scoped f_construct(t_type* a_class, bool a_rgba, bool a_double_buffer, bool a_alpha)
	{
		return xemmaix::xraft::t_proxy::f_construct(a_class, new xraft::t_opengl_format(a_rgba, a_double_buffer, a_alpha));
	}
	static t_scoped f_construct(t_type* a_class, bool a_rgba, bool a_double_buffer, bool a_alpha, bool a_depth)
	{
		return xemmaix::xraft::t_proxy::f_construct(a_class, new xraft::t_opengl_format(a_rgba, a_double_buffer, a_alpha, a_depth));
	}
	static t_scoped f_construct(t_type* a_class, bool a_rgba, bool a_double_buffer, bool a_alpha, bool a_depth, bool a_stencil)
	{
	...
	static t_scoped f_construct(t_type* a_class, bool a_rgba, bool a_double_buffer, bool a_alpha, bool a_depth, bool a_stencil, bool a_accumulation)
	{
...
{
	static t_scoped f_construct(t_type* a_class, const xraft::t_pointer<xraft::t_opengl_format>& a_format)
	{
		return xemmaix::xraft::t_proxy::f_construct(a_class, new xraft::t_opengl_context(a_format));
	}
	static t_scoped f_construct(t_type* a_class, const xraft::t_pointer<xraft::t_opengl_format>& a_format, const xraft::t_pointer<xraft::t_opengl_context>& a_share)
	{
