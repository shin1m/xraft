...
class t_application
{
	...
	Time v_time = CurrentTime;
	int v_post;
	std::vector<t_listener> v_listeners;
	size_t v_notifier = 0;
	t_timer* v_timer = nullptr;
	t_window* v_invalids = nullptr;
	t_shell* v_active = nullptr;
	t_window* v_focus = nullptr;
	t_window* v_pointer_grabber = nullptr;
	t_cursor v_cursor_x = None;
	t_cursor v_cursor_arrow = None;
	t_cursor v_cursor_ibeam = None;
	t_cursor v_cursor_vslide = None;
	t_cursor v_cursor_hslide = None;
	t_cursor v_cursor_top = None;
	t_cursor v_cursor_bottom = None;
	t_cursor v_cursor_left = None;
	t_cursor v_cursor_right = None;
	t_cursor v_cursor_top_left = None;
	t_cursor v_cursor_top_right = None;
	t_cursor v_cursor_bottom_left = None;
	t_cursor v_cursor_bottom_right = None;
	...
	bool v_input_negotiating = false;
	bool v_input_composing = false;
	t_pointer<t_input_context> v_input_context;
	std::vector<t_pointer<t_shell>> v_shells;
	int v_x = 0;
	int v_y = 0;
	unsigned int v_width = 512;
	unsigned int v_height = 384;
